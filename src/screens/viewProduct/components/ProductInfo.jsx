    ...
    <Box sx={{ px: { xs: 3, md: 0 }, py: { xs: 0, md: 3 } }}>
      ...
      >
        ...
        <Stack direction="row" spacing={3}>
          <Typography variant="h2" gutterBottom sx={{ textAlignLast: "left" }}>
      ...
      <Stack direction="row" spacing={1} my={3}>
        ...
        <Typography variant="body1" sx={{ mb: 2, color: "secondary.dark" }}>
      ...
      <Stack direction="row" alignItems="center" spacing={2} sx={{ my: 3 }}>
        <Typography variant="h3" color="primary">
          {isLoading ? <Skeleton width={100} /> : formatPrice(product.price)}
        </Typography>
