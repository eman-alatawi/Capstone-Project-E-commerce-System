            ...
            <AccordionDetails>
              <Stack spacing={2}>
                <Typography variant="body1">
                  Name:{" "}
                  <span style={{ color: "#b0aeac" }}>{userProfile.fullname}</span>
                </Typography>
                ...
                <Typography variant="body1">
                  Phone Number:{" "}
                  <span style={{ color: "#b0aeac" }}>{userProfile.mobile}</span>
                </Typography>
              </Stack>
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              <Stack spacing={2}>
                <Typography variant="body1">
                  Country:{" "}
                  <span style={{ color: "#b0aeac" }}>{userProfile.country}</span>
                </Typography>
                ...
                <Typography variant="body1">
                  Address:{" "}
                  <span style={{ color: "#b0aeac" }}>{userProfile.address}</span>
                </Typography>

                <Typography variant="body1">
                  Postal Code:{" "}
                  <span style={{ color: "#b0aeac" }}>{userProfile.postal_code}</span>
                </Typography>
              </Stack>
            </AccordionDetails>
          </Accordion>
